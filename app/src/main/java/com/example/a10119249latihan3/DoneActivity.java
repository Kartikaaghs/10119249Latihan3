package com.example.a10119249latihan3;
...
public class DoneActivity extends AppCompatActivity {
    ...
    private void bindExtra(){
        ...
        String name = intent.getStringExtra(com.example.a10119249latihan3.BiodataActivity.ID_EXTRA_MSG);
        txtNama.setText(beres+" "+ name +" "+sudahBisa+" "+ name +" "+setiap+" "+ name +" "+buat);
    }

    @OnClick(R.id.btnDoneNext)
    public void selesai(View view) {
        Intent intent = new Intent(this, com.example.a10119225_latihan3.MainActivity.class);
